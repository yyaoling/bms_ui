        ...
        <div class="panel">
          <div class="setting-main">
            ...
            <Row type="flex" :gutter="30" justify="space-around">
              ...
              <Col :span="11">
                <img :src="uploadImgSrc" height="130">
              </Col>
            </Row>
            ...
            <Form ref="formBook" :model="formBook" :rules="ruleBook">
              <Row type="flex" :gutter="30" justify="space-around">
                <Col :span="11">
                  <FormItem label="ISBN" prop="isbn">
                    <Input v-model="formBook.isbn"></Input>
                  </FormItem>
              ...
              <Row type="flex" :gutter="30" justify="center">
                <Col :span="23">
                  ...
                  <FormItem>
                    <Button type="primary" @click="addBook" :loading="loadingSaveBtn">保存</Button>
                  </FormItem>
                </Col>
              </Row>
            </Form>
        ...
        if (valid && this.uploadImgSrc) {
          ...
          await checkBookExists(this.formBook.isbn).then(async recCheck => {
            if (recCheck.data === true) {
              ...
              this.formBook.coverImage = 'https://bms-1302010632.cos.ap-nanjing.myqcloud.com/cover/' + fileName;
